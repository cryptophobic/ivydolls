    ...
    var loadMyCartEvent = function (userOptions) {
        ...
        if (!$("#" + idCartModal).length) {
            $('body').append(
                ...
                '<button type="button" class="btn btn-success ' + classCheckoutCart + '">Заказать</button>' +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>'
        ...
        var drawTable = function () {
            ...
            $.each(products, function () {
                ...
                $cartTable.append(
                    ...
                    '<td class="text-center" style="width: 30px; height: 30px;"><img width="30px" src="' + this.image + '"/></td>' +
                    '<td>' + '&nbsp;'+this.name + '</td>' +
            ...
            $cartTable.append(products.length ?
                ...
                '<td></td>' +
                '</tr>'
                    : '<div class="alert alert-danger" role="alert" id="' + idEmptyCartMessage + '">В корзине ничего нет</div>'
            );
            ...
            if (products.length && discountPrice !== null) {
                $cartTable.append(
                    '<tr style="color: red">' +
                    '<td></td>' +
                    '<td><strong>Сумма (со скидкой)</strong></td>' +
                    '<td></td>' +
                    '<td></td>' +
        ...
        var showDiscountPrice = function () {
            $("#" + idDiscountPrice).text(options.getDiscountPrice(ProductManager.getAllProducts() + ' ' + options.currencySymbol, ProductManager.getTotalPrice(), ProductManager.getTotalQuantity()));
        }
        ...
        $(document).on("input", "." + classProductQuantity, function () {
            ...
            $(this).parent("td").next("." + classProductTotal).text((price * quantity) + ' грн');
